/* =========================================
   ...
   ========================================= */
const facilities = [
  { id: "mph",                 label: "MPH",                   icon: "warehouse",      capacity: "300",         available: true,  category: "academic",   location: "TPU Com",        desc: "Multi-purpose hall for indoor sports, assemblies, and events.", image: "https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?auto=format&fit=crop&w=600&q=80" },
  { id: "pcr_1",               label: "PCR 1",                 icon: "presentation",   capacity: "30",          available: true,  category: "academic",   location: "TPU Com",        desc: "Smart classroom equipped with modern presentation resources.", image: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=600&q=80" },
  { id: "pcr_2",               label: "PCR 2",                 icon: "presentation",   capacity: "30",          available: true,  category: "academic",   location: "TPU Com",        desc: "Collaborative learning space with high-speed internet and displays.", image: "https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?auto=format&fit=crop&w=600&q=80" },
  { id: "pcr_4",               label: "PCR 4",                 icon: "presentation",   capacity: "30",          available: true,  category: "academic",   location: "TPU Com",        desc: "Dedicated presentation room with hybrid conferencing setup.", image: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=600&q=80" },
  { id: "av_room",             label: "AV Room",               icon: "clapperboard",   capacity: "50",          available: true,  category: "academic",   location: "TPU Com",        desc: "Acoustically treated room for media preview and small screenings.", image: "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?auto=format&fit=crop&w=600&q=80" },
  { id: "comp_lab_1",          label: "Comp Lab 1",            icon: "monitor",        capacity: "40",          available: true,  category: "academic",   location: "TPU Com",        desc: "Computer lab featuring workstations with specialized software.", image: "https://images.unsplash.com/photo-1547082299-de196ea013d6?auto=format&fit=crop&w=600&q=80" },
  { id: "comp_lab_2",          label: "Comp Lab 2",            icon: "monitor",        capacity: "40",          available: true,  category: "academic",   location: "TPU Com",        desc: "Advanced programming and database systems laboratory room.", image: "https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=600&q=80" },
  { id: "swimming",            label: "Swimming",              icon: "waves",          capacity: "Open Space",  available: true,  category: "recreation", location: "Sports Complex", desc: "Half-Olympic size indoor swimming pool with temperature controls.", image: "https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?auto=format&fit=crop&w=600&q=80" },
  { id: "fitness",             label: "Fitness",               icon: "dumbbell",       capacity: "50",          available: true,  category: "recreation", location: "Sports Complex", desc: "Fully equipped gymnasium with cardio machines and weights.", image: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=600&q=80" },
  { id: "bb",                  label: "BB",                    icon: "basketball",     capacity: "Open Space",  available: true,  category: "recreation", location: "Sports Complex", desc: "Indoor wooden-floor court for basketball games and practice.", image: "https://images.unsplash.com/photo-1546519638-68e109498ffc?auto=format&fit=crop&w=600&q=80" },
  { id: "bt",                  label: "BT",                    icon: "swords",         capacity: "Open Space",  available: true,  category: "recreation", location: "Sports Complex", desc: "Multi-court indoor badminton facility with synthetic flooring.", image: "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?auto=format&fit=crop&w=600&q=80" },
  { id: "revel",               label: "Revel",                 icon: "disc",           capacity: "50",          available: true,  category: "recreation", location: "Sports Complex", desc: "Recreation lounge and dynamic student activities hub.", image: "https://images.unsplash.com/photo-1511192336575-5a79af67a629?auto=format&fit=crop&w=600&q=80" },
  { id: "indoor_play",         label: "Indoor Play Area",      icon: "smile",          capacity: "Open Space",  available: true,  category: "recreation", location: "TPU Sci",        desc: "Indoor recreational play area for table games and activities.", image: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=600&q=80" },
  { id: "auditorium",          label: "Auditorium",            icon: "mic-2",          capacity: "500",         available: false, category: "media",      location: "TPU Sci",        desc: "Grand auditorium with 500-seat capacity, surround PA system, and backstage.", image: "https://images.unsplash.com/photo-1585699324551-f6c309eed262?auto=format&fit=crop&w=600&q=80" },
  { id: "turf_lg_1",           label: "Turf LG 1",             icon: "layout-grid",    capacity: "Open Space",  available: true,  category: "recreation", location: "New Turf",       desc: "Outdoor artificial grass turf for football and athletic sessions.", image: "https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=600&q=80" },
  { id: "turf_lg_2",           label: "Turf LG 2",             icon: "layout-grid",    capacity: "Open Space",  available: true,  category: "recreation", location: "New Turf",       desc: "Lower ground football turf with floodlight support.", image: "https://images.unsplash.com/photo-1518063319789-7217e6706b04?auto=format&fit=crop&w=600&q=80" },
  { id: "turf_lg_3",           label: "Turf LG 3",             icon: "layout-grid",    capacity: "Open Space",  available: true,  category: "recreation", location: "New Turf",       desc: "Premium synthetic grass field for training and matches.", image: "https://images.unsplash.com/photo-1551958219-acbc608c6377?auto=format&fit=crop&w=600&q=80" },
  { id: "turf_lg_4",           label: "Turf LG 4",             icon: "layout-grid",    capacity: "Open Space",  available: true,  category: "recreation", location: "New Turf",       desc: "Additional outdoor lower ground sports pitch.", image: "https://images.unsplash.com/photo-1459865264687-595d652de67e?auto=format&fit=crop&w=600&q=80" },
  { id: "turf_ug_5",           label: "Turf UG 5",             icon: "grid",           capacity: "Open Space",  available: true,  category: "recreation", location: "New Turf",       desc: "Upper ground turf suitable for small-sided games and practice.", image: "https://images.unsplash.com/photo-1529900748604-07564a03e7a6?auto=format&fit=crop&w=600&q=80" },
  { id: "turf_ug_6",           label: "Turf UG 6",             icon: "grid",           capacity: "Open Space",  available: true,  category: "recreation", location: "New Turf",       desc: "Upper ground synthetic field with spectator seating.", image: "https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=600&q=80" },
  { id: "turf_ug_7",           label: "Turf UG 7",             icon: "grid",           capacity: "Open Space",  available: true,  category: "recreation", location: "New Turf",       desc: "Synthetic multi-sport grass turf on the upper level.", image: "https://images.unsplash.com/photo-1536122985607-4fe00b283652?auto=format&fit=crop&w=600&q=80" },
  { id: "turf_ug_8",           label: "Turf UG 8",             icon: "grid",           capacity: "Open Space",  available: true,  category: "recreation", location: "New Turf",       desc: "Dedicated practice pitch on the upper level complex.", image: "https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=600&q=80" },
  { id: "tgis_turf",           label: "TGIS Turf",             icon: "award",          capacity: "Open Space",  available: true,  category: "recreation", location: "TGIS",           desc: "TGIS campus sports turf for tournaments and training.", image: "https://images.unsplash.com/photo-1518063319789-7217e6706b04?auto=format&fit=crop&w=600&q=80" },
  { id: "tgis_dance",          label: "TGIS Dance & Fitness",  icon: "activity",       capacity: "40",          available: true,  category: "recreation", location: "TGIS",           desc: "TGIS studio with full-length mirrors and wooden flooring.", image: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?auto=format&fit=crop&w=600&q=80" },
  { id: "tgis_karate",         label: "TGIS Karate",           icon: "shield",         capacity: "30",          available: true,  category: "recreation", location: "TGIS",           desc: "TGIS martial arts training room with safety mats and bags.", image: "https://images.unsplash.com/photo-1555597673-b21d5c935865?auto=format&fit=crop&w=600&q=80" },
  { id: "tt",                  label: "TT",                    icon: "table",          capacity: "8",           available: true,  category: "recreation", location: "Boys Hostel",    desc: "Table tennis room with tournament-grade tables in Boys Hostel.", image: "https://images.unsplash.com/photo-1534067783941-51c9c23eccfd?auto=format&fit=crop&w=600&q=80" }
];
